...
* [x] **Training Engine**: LoRA/QLoRA fine-tuning, live progress monitoring, automatic checkpointing.
...
* [ ] **GGUF / llama.cpp Export**: Native GGUF export for direct execution on Ollama, LM Studio, and Apple Silicon.
...
* [ ] **Direct Preference Optimization (DPO)**: Autonomous alignment and preference optimization stage in Autopilot.
